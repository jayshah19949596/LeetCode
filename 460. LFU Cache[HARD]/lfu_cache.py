...
class LFUCache:
    def __init__(self, capacity: int):
        ...
        self.key_to_freq_value = {}  # key -> (frequency, value)
    ...
    def put(self, key: int, value: int) -> None:
        ...
        if key in self.key_to_freq_value:
            ...
            frequency, _ = self.key_to_freq_value[key]
            self.key_to_freq_value[key] = (frequency, value)
            return

        # Evict if at capacity
        if len(self.key_to_freq_value) == self.capacity:
            evict_key, _ = self.freq_to_keys[self.min_frequency].popitem(last=False)
            del self.key_to_freq_value[evict_key]
